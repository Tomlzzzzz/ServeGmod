...
if CLIENT then
	...
	local EC_FONT = CreateConVar("easychat_font", "Poppins", FCVAR_ARCHIVE, "Set the font to use for the chat")
	...
	EasyChat.DefaultColors = {
		outlay = Color(11, 23, 42, 240),
		outlayoutline = Color(45, 170, 225, 255),
		tab = Color(11, 23, 42, 220),
		taboutline = Color(45, 170, 225, 255),
	}
